...
class Logger implements LoggerInterface, ResettableInterface
{
    ...
    /**
     * Processors that will process all logs records
     *
     ...
     *
     * @param string             $name       The logging channel, a simple descriptive name that is attached to all logs records
     ...
     * @param  mixed[] $context The logs context
    ...
    /**
     * Ends a logs cycle and frees all resources used by handlers.
     *
     * Closing a Handler means flushing all buffers and freeing any open resources/handles.
     * Handlers that have been closed should be able to accept logs records again and re-open
    ...
    /**
     * Ends a logs cycle and resets all handlers and processors to their initial state.
     *
     * Resetting a Handler or a Processor means flushing/cleaning all buffers, resetting internal
     * state, and getting it back to a state in which it can receive logs records again.
     *
    ...
    public static function toMonologLevel($level): int
    {
        if (is_string($level)) {
            ...
            // Contains chars of all logs levels and avoids using strtoupper() which may have
    ...
    /**
     * Adds a logs record at an arbitrary level.
     *
     * This method allows for compatibility with common interfaces.
     *
     * @param mixed             $level   The logs level
     * @param string|Stringable $message The logs message
     * @param mixed[]           $context The logs context
     *
     * @phpstan-param Level|LevelName|LogLevel::* $level
     */
    ...
    /**
     * Adds a logs record at the DEBUG level.
     *
     * This method allows for compatibility with common interfaces.
     *
     * @param string|Stringable $message The logs message
    ...
    /**
     * Adds a logs record at the INFO level.
     *
     * This method allows for compatibility with common interfaces.
     *
     * @param string|Stringable $message The logs message
    ...
    /**
     * Adds a logs record at the NOTICE level.
     *
     * This method allows for compatibility with common interfaces.
     *
     * @param string|Stringable $message The logs message
    ...
    /**
     * Adds a logs record at the WARNING level.
     *
     * This method allows for compatibility with common interfaces.
     *
     * @param string|Stringable $message The logs message
    ...
    /**
     * Adds a logs record at the ERROR level.
     *
     * This method allows for compatibility with common interfaces.
     *
     * @param string|Stringable $message The logs message
    ...
    /**
     * Adds a logs record at the CRITICAL level.
     *
     * This method allows for compatibility with common interfaces.
     *
     * @param string|Stringable $message The logs message
    ...
    /**
     * Adds a logs record at the ALERT level.
     *
     * This method allows for compatibility with common interfaces.
     *
     * @param string|Stringable $message The logs message
    ...
    /**
     * Adds a logs record at the EMERGENCY level.
     *
     * This method allows for compatibility with common interfaces.
     *
     * @param string|Stringable $message The logs message
    ...
    /**
     * Sets the timezone to be used for the timestamp of logs records.
     */
    ...
    /**
     * Returns the timezone to be used for the timestamp of logs records.
     */

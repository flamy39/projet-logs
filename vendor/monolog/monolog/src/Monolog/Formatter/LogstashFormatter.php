...
/**
 * Serializes a logs message to Logstash Event Format
 *
...
{
    /**
     * @var string the name of the system for the Logstash logs message, used to fill the @source field
     */
    protected $systemName;

    /**
     * @var string an application name for the Logstash logs message, used to fill the @type field
     */

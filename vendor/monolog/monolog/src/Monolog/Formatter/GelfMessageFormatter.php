...
/**
 * Serializes a logs message to GELF
...
class GelfMessageFormatter extends NormalizerFormatter
{
    ...
    /**
     * @var string the name of the system for the Gelf logs message
     */
    ...
    /**
     * Translates Monolog logs levels to Graylog2 logs priorities.
     *
     * @var array<int, int>
     *

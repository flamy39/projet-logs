...
/**
 * Handler to only pass logs messages when a certain threshold of number of messages is reached.
 *
...
class OverflowHandler extends AbstractHandler implements FormattableHandlerInterface
{
     ...
     * calling further handlers in the stack with a given logs record.
     *
     * {@inheritDoc}
     */

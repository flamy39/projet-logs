 ...
 *
 * Display PHP error/debug logs messages in Google Chrome console and notification popups, executes PHP code remotely
 *
 * Usage:
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    /**
     * Writes the record down to the logs of the implementing handler
     */

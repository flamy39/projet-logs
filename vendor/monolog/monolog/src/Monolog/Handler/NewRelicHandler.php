...
/**
 * Class to record a logs on a NewRelic application.
...
class NewRelicHandler extends AbstractProcessingHandler
{
    ...
    /**
     * Returns the appname where this logs should be sent. Each logs can override the default appname, set in this
    ...
    /**
     * Returns the name of the current transaction. Each logs can override the default transaction name, set in this
    ...
    /**
     * Sets the NewRelic application that should receive this logs.
     */
